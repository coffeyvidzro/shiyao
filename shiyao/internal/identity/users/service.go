...
func (s *Service) GetMe(ctx context.Context, userID uuid.UUID) (sqlc.User, error) {
	return s.repo.GetByID(ctx, userID)
}

func (s *Service) UpdateMe(ctx context.Context, userID uuid.UUID, req UpdateMeRequest) (sqlc.User, error) {
