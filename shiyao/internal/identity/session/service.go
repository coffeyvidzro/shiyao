...
func (s *Service) Create(ctx context.Context, userID uuid.UUID, ipAddress *string, userAgent *string) (string, sqlc.Session, error) {
...
func (s *Service) Revoke(ctx context.Context, sessionID uuid.UUID, userID uuid.UUID) error {
	return s.repo.Revoke(ctx, sqlc.RevokeSessionParams{ID: sessionID, UserID: userID})
}
